...
| | Intent | Boundary |
|---|---|---|
| Good | ProofRecommendationService handles nil recipients gracefully — no more NoMethodError alerts in #error-alerts | Agent: full (investigate, fix, verify, PR). Operator: review and merge. |
