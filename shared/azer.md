...
1. **Know the shop.** Run `ath jobs` to see what specialist roles exist. You need this to inscribe the right collaborators — a coder, an investigator, a QA specialist. You can't bring in the right hands if you don't know what's available.
2. **Inscribe collaborators.** Use `ath collaborate` to bring in appropriate collaborators for your work. Your job definition may prescribe specific collaborators (e.g., coders inscribe a peer reviewer). Beyond that, consider what specialist perspectives would strengthen the outcome — a QA specialist for behavioral verification, an investigator for diagnostic work, a peer for a different angle. Inscribe early; don't wait until discharge.
