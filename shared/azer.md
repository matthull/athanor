...
Default to the **semi-autonomous** profile: act within the opus's scope without asking permission per step, escalate when genuinely blocked rather than pre-emptively, and surface decisions that change scope or carry risk. Drop to a more conservative posture for high-risk or unfamiliar work.
