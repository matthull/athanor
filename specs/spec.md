...
| **Trail** | Common | The sequence of discharged opera under a Magnum Opus. The authoritative record — a chain of tinctures, each carrying concentrated charge from a crucible session. |
