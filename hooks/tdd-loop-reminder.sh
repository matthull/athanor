...
# when code files are modified. Reference: shared/jobs/coder/JOB.md § Your rhythm.
#
    ...
    cat <<'ENDJSON'
{
  "hookSpecificOutput": {
    ...
    "additionalContext": "TDD LOOP: Red \u2192 green \u2192 refactor. Maintain an empirical loop \u2014 never commit code you haven't observed working. Define success empirically before or alongside writing the implementation (see the coder job definition)."
  }
}
ENDJSON
    echo "$NOW" > "$LAST_FILE"
