...
The error channel stays clean, actionable errors get actioned.
...
`,
			heading: "Goal",
			want:    "The error channel stays clean, actionable errors get actioned.",
		},
		{
...
func TestExtractTitle(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "simple title",
			content: "# Fix NoMethodError in NotificationService\n\n## Goal\n",
			want:    "Fix NoMethodError in NotificationService",
		},
		{
