...
func TestInitInstance(t *testing.T) {
	...
	// Init the instance
	if err := InitInstance(home, "test-project", "/home/user/code/test"); err != nil {
	...
	if cfg.Project != "/home/user/code/test" {
...
func TestEnvLocalPath(t *testing.T) {
	t.Parallel()
	got := EnvLocalPath("/home/user/athanor/athanors/myath")
	want := "/home/user/athanor/athanors/myath/.env.local"
	if got != want {
